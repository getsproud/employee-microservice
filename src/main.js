...
const connectRetry = t => {
  ...
  return connect(`mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@sproud-cluster-${process.env.NODE_ENV !== 'production' ? '-dev' : ''}cluster.divei.mongodb.net/sproud${process.env.NODE_ENV === 'development' ? '-dev' : ''}?retryWrites=true&w=majority`, {
